            ...
            <div class="col-xl-12">
                <div class="card pt-2">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('aksi_e_buku', $produk->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <h6 style="margin-top:16px">Nama Buku</h6>
                                <input class="form-control" name="produk_nama" value="{{ $produk->produk_nama }}" type="text" placeholder="Nama Produk" aria-label="default input example">
                            <h6 style="margin-top:16px">Harga Buku</h6>
                                <input class="form-control" name="produk_harga" value="{{ $produk->produk_harga }}" type="text" placeholder="Harga" aria-label="default input example">
                            <h6 style="margin-top:16px">Pilih Gambar Buku</h6>
                                <img id="imagePreview" src="{{ asset('global/assets/produk') }}/{{ $produk->produk_foto }}" style="max-width: 200px; max-height: 200px; margin-bottom: 16px;">
                                <input type="hidden" name="foto" value="{{ asset('global/assets/produk') }}/{{ $produk->produk_foto }}">
                            ...
                            <h6 style="margin-top:16px">Deskripsi Buku</h6>
                                <div class="form-floating">
                                    <textarea class="form-control" name="produk_deskripsi" placeholder="Deskripsi" style="height: 100px">{{ $produk->produk_deskripsi }}</textarea>
                                </div>
